...
Config.discordLink = "https://discord.gg/x88dzMfyRM" -- Used in server convars


Config.serverName = "🌍 ^3Drift^1V ^1Remastered  ^9| ^6 Drift Economy ^9| ^6 Garages  ^9| ^6 Crews  ^9| ^6 Car Crew Battles  ^9| ^6 Drift Trials  ^9| ^6 Custom framework"
